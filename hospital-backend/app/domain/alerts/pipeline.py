...
from .generators.vital import generate_vital_alert as _generate_vital_alert
...
class AlertPipeline:
    ...
    async def generate_vital_alert(
        ...
        """
        # Generate alert using centralized generator
        alert = _generate_vital_alert(patient_id, vital_type, vital_value, device_id)
