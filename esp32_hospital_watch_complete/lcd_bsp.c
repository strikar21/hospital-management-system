...
void lcd_lvgl_Init(void)
{
  ...
  // ✅ v5.3: Use single buffer to save DMA RAM (double buffer = 128KB, too much for ESP32-S3)
  lv_color_t *buf1 = heap_caps_malloc(EXAMPLE_LCD_H_RES * EXAMPLE_LVGL_BUF_HEIGHT * sizeof(lv_color_t), MALLOC_CAP_DMA);
  assert(buf1);

  // Single buffering: buf2 = NULL (saves 64KB of DMA RAM)
  ...
  {
    // ✅ Removed LVGL demos - we have our own UIScreens instead
